...
function Contact() {
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-[#012d36] via-[#02343f] to-[#034652] text-[#F0EDCC] overflow-hidden flex">
      {/* Sidebar (desktop) */}
      <aside className="hidden md:flex flex-col w-1/5 border-r border-[#F0EDCC]/20 px-4 py-6">
